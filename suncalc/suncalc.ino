...
const long J1970 = 2440588,
	J2000 = 2451545;

const double M0 = 357.5291 * DEG2RAD,
...
#define timestampToJulianDate(timestamp) (timestamp / SECONDS_IN_DAY + J1970 - 0.5f)

// double timestampToJulianDate(long timestamp) {
// 	return ((double) timestamp / SECONDS_IN_DAY) + J1970 - 0.5f;
// }
